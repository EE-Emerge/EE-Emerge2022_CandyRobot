...
![robot]({{site.baseurl}}/assets/css/vacuunhead.png | width=100)
...
![Power supply box inside view]({{site.baseurl}}/assets/css/box1.jpg | width=100)
![Power supply box outside view]({{site.baseurl}}/assets/css/box2.jpg | width=100)
